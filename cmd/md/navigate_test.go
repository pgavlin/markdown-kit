...
func TestFetchURL_CacheFresh(t *testing.T) {
	...
	result, err := fetchURL("http://example.com", &builtinConverter{}, c, client, logger)
	if err != nil {
...
func TestFetchURL_MarkdownResponse(t *testing.T) {
	...
	result, err := fetchURL("http://example.com/doc.md", &builtinConverter{}, nil, client, discardLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestFetchURL_HTMLResponse(t *testing.T) {
	...
	result, err := fetchURL("http://example.com", conv, nil, client, discardLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if result.markdown != "# Hello" {
...
func TestFetchURL_HTTPError(t *testing.T) {
	...
	_, err := fetchURL("http://example.com", &builtinConverter{}, nil, client, discardLogger())
	if err == nil {
...
func TestFetchURL_NilCache(t *testing.T) {
	...
	result, err := fetchURL("http://example.com", &builtinConverter{}, nil, client, discardLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestFetchURL_ConditionalHeaders(t *testing.T) {
	...
	_, err := fetchURL("http://example.com", &builtinConverter{}, c, client, logger)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
